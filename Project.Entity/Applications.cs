...
namespace Project.Entity
{
   public class Applications
    {
        public long MerchantApp_ID { get; set; }
        ...
        public string OwnershipTyp { get; set; }
        ...
        public string GatewayAccessFee { get; set; }

        public string GatewayPerAuthFee { get; set; }

        public string GatewaySetUpFee { get; set; }

        public string WirelessAccessFee { get; set; }

        public string WirelessPerAuthFee { get; set; }

        public string WirelessSetupFee { get; set; }

        public string RetrievalFee { get; set; }

        public XElement App { get; set; }
