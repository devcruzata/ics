                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    for (int i = 0; i < files.Count; i++)
                    {
                        ...
                        foreach (DataRow dr in dt.Rows)
                        {
                            ...
                            objLeadModel.EstMontVolume = dr[8].ToString();
                            objLeadModel.MerAppUsername = dr[9].ToString();
                            objLeadModel.MerAppPassword = dr[10].ToString();
                            objLeadModel.LBusiName = dr[11].ToString();
                            objLeadModel.OwnershipType = dr[12].ToString();
                            objLeadModel.YrInBusiness = dr[13].ToString();
                            objLeadModel.MtInBusiness = dr[14].ToString();
                            objLeadModel.BDescription = dr[15].ToString();
                            objLeadModel.LAddress1 = dr[16].ToString();
                            objLeadModel.LAddress2 = dr[17].ToString();
                            objLeadModel.city = dr[18].ToString();
                            objLeadModel.state = dr[19].ToString();
                            objLeadModel.zip = dr[20].ToString();
                            objLeadModel.LPhoneNo = dr[21].ToString();
                            objLeadModel.LFaxNo = dr[22].ToString();
                            objLeadModel.MAddress1 = dr[23].ToString();
                            objLeadModel.MAddress2 = dr[24].ToString();
                            objLeadModel.mcity = dr[25].ToString();
                            objLeadModel.mstate = dr[26].ToString();
                            objLeadModel.mzip = dr[27].ToString();


                            objLeadModel.FName = dr[28].ToString();
                            objLeadModel.LName = dr[29].ToString();
                            objLeadModel.DOB = dr[30].ToString();
                            objLeadModel.SocSecurity = dr[31].ToString();
                            objLeadModel.DLicense = dr[32].ToString();
                            objLeadModel.DLicenseState = dr[33].ToString();
                            objLeadModel.RAddress1 = dr[34].ToString();
                            objLeadModel.RAddress2 = dr[35].ToString();
                            objLeadModel.rcity = dr[36].ToString();
                            objLeadModel.rstate = dr[37].ToString();
                            objLeadModel.rzip = dr[38].ToString();
                            objLeadModel.OwnerPhone = dr[39].ToString();

                            objLeadModel.MerchantType = dr[40].ToString();
                            objLeadModel.RSwiped = dr[41].ToString();
                            objLeadModel.RKeyed = dr[42].ToString();
                            objLeadModel.MTOrders = dr[43].ToString();
                            objLeadModel.internet = dr[44].ToString();
                            objLeadModel.avgTicket = dr[45].ToString();
                            objLeadModel.highTicket = dr[46].ToString();
                            objLeadModel.MVolume = dr[47].ToString();
                            objLeadModel.BName = dr[48].ToString();
                            objLeadModel.BCity = dr[49].ToString();
                            objLeadModel.BState = dr[50].ToString();
                            objLeadModel.BZip = dr[51].ToString();
                            objLeadModel.BRoutNumber = dr[52].ToString();
                            objLeadModel.BacNumber = dr[53].ToString();

                            objLeadModel.Equipment = dr[54].ToString();
                            objLeadModel.DebitQual = dr[55].ToString();
                            objLeadModel.DebitMIDQual = dr[56].ToString();
                            objLeadModel.DebitNonQual = dr[57].ToString();
                            objLeadModel.CreditQual = dr[58].ToString();
                            objLeadModel.CreditMIDQual = dr[59].ToString();
                            objLeadModel.CreditNonQual = dr[60].ToString();
                            objLeadModel.DebitQualPerItem = dr[61].ToString();
                            objLeadModel.DebitMIDQualPerItem = dr[62].ToString();
                            objLeadModel.DebitNonQualPerItem = dr[63].ToString();
                            objLeadModel.CreditQualPerItem = dr[64].ToString();
                            objLeadModel.CreditMIDQualPerItem = dr[65].ToString();
                            objLeadModel.CreditNonQualPerItem = dr[66].ToString();
                            objLeadModel.DebitTransFee = dr[67].ToString();
                            objLeadModel.ReturnTransFee = dr[68].ToString();
                            objLeadModel.EBTTransFee = dr[69].ToString();
                            objLeadModel.ElectroAVSFee = dr[70].ToString();
                            objLeadModel.AMEXTransFee = dr[71].ToString();
                            objLeadModel.StatementFee = dr[72].ToString();
                            objLeadModel.MontMini = dr[73].ToString();
                            objLeadModel.ChargeBackFee = dr[74].ToString();
                            objLeadModel.BatchFee = dr[75].ToString();
                            objLeadModel.GatewayFee = dr[76].ToString();
                            objLeadModel.WirelessFee = dr[77].ToString();
                            objLeadModel.RetrievalFee = dr[78].ToString();
                            objLeadModel.AssignToID = Convert.ToInt64(dr[79]);
